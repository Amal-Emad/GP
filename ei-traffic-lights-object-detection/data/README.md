...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-563333 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-563333 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-563333 --data-directory data --out-directory out
    ```
